...
public class AggregatedJoinTreeNode extends JoinTreeNode {
    ...
    public AggregatedJoinTreeNode(AggregatedRelation relation, List<String> reserve, List<Integer> hintJoinOrder, Long cardinality) {
        super(relation.getRelationId(), "AggregatedRelation", relation.getTableDisplayName(), reserve, hintJoinOrder, cardinality);
